...
<body>
	...
	<div id="header">
		...
		<div id="navigation">
			<ul>
			    <li><a href="<%= request.getContextPath() %>/html/showProperty.action" class="active" title="Home"><span>Search</span></a></li>
	...
	<!-- End Header -->
		...
		<div id="button"><input type="submit" value="Press me please!" Class="button"/></div>
	
	<div id="popupContact">
		<a id="popupContactClose">x</a>
		<h1 style="COLOR: #000080;">Aasov, <i>Happiness Always</i>!</h1>
			<s:form action="loginAction" windowState="exclusive" >
					<h1>Member Login</h1>
					<s:actionerror />
					<s:textfield cssClass="textboxcss" label="Email ID" name="email" size="23" />
					<s:password cssClass="textboxcss" label="Password" name="password" size="23" />
	            	<s:checkbox name="rememberme" label="Remember me" value="forever" />
					<s:submit  name="submit" value="Login" cssClass="btnExample" />
				</s:form>
				<br></br>
				<p id="contactArea">
				<a href="#" tabindex="100" shape="rect" style="FONT-SIZE: medium;" onclick="popUp('/myp/aasov/lostPassword.jsp')" ><u>Lost Your Password?</u></a>
				&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
				<a href="#" tabindex="100" style="FONT-SIZE: medium;" onclick="popUp('/myp/aasov/newUser.jsp')"><u>New User</u></a>
		</p>
	</div>
