...
<div class="box">
		<h1 style="FONT-SIZE: large; COLOR: #000080;">Aasov, <i>Happiness Always</i>!</h1>
			<s:form action="addUserAction" >
					<h1 style="FONT-SIZE: large;">Hello Guest!</h1>
					<s:actionerror />
					<s:actionmessage/>
					<s:textfield cssClass="textboxcss" label="First Name" name="fname" size="23" value="" />
					<s:textfield cssClass="textboxcss" label="Email" name="email" size="23" value="" />
	            	<s:checkbox name="rememberme" label="Remember me" value="forever" />
					<s:submit  name="submit" value="Register Me" cssClass="btnExample" />
				</s:form>
	</div>	
</div>
